...
const RelatedProducts = () => {
  ...
  return (
    <div className="flex flex-col items-center">
        <h2 className="my-14 font-poppins text-4xl font-medium">Related Products</h2>
            ...
            {visibleProduct < relatedProducts.length && (
                <div className="flex justify-center">
                    <button
                        ...
                        className='font-poppins font-semibold text-[#B88E2F] text-base w-60 h-12 border border-[#B88E2F] mt-4'
                    >
                        Show More
                    </button>
                </div>
