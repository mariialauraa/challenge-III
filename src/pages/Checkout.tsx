...
const Checkout = () => {
    ...
    const handleFormSubmit = (data: CheckoutFormSchema, resetForm: () => void) => {
        if (!paymentMethod) {
                    ...
                    <section className="flex flex-col mx-auto w-full md:w-1/2 px-4 md:mr-24">
                        ...
                        <div>
                            <p className="font-poppins text-base font-light">
                                Your personal data will be used to support your experience throughout this website, to manage access to your account, and for other purposes descritos na nossa <span className="font-semibold">política de privacidade</span>.  
                            </p>
                        </div>
